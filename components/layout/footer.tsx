          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row">
              <input
                ...
                className="w-full px-3 py-2 bg-gray-800 text-white rounded-md sm:rounded-l-md sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-blue-600"
              />
              <button className="mt-2 sm:mt-0 w-full sm:w-auto px-4 py-2 bg-blue-600 text-white rounded-md sm:rounded-l-none sm:rounded-r-md hover:bg-blue-700 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
